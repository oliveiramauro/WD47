...
!function (e, i, Jt) {
  ...
  !function (r) {
    ...
    if (r(8)) {
      var g = r(30),
        ...
        kt(this);var n = It(arguments[1], 1),
            ...
            e = p(t),
            i = x(e.length),
            o = 0;if (r < i + n) throw B(Mt);for (; o < i;) {
          this[n + o] = e[o++];
        }
      },
          ...
          Bt = function Bt(t, n) {
        return P(t) && t[xt] && "symbol" != (typeof n === "undefined" ? "undefined" : _typeof(n)) && n in t && String(+n) == String(n);
      },
    ...
    var e = r(2),
      ...
      var u = p(+r);if (t[D] < u + n) throw M(m);for (var c = t[R]._b, f = u + t[L], a = e(+i), s = 0; s < n; s++) {
        c[f + s] = a[o ? s : n - s - 1];
      }
    }if (u.ABV) {
      if (!a(function () {
